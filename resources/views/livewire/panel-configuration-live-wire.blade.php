<div class="wizard-container mt-5">
    ...
    <div class="steps">
        ...
        @if ($typeConfiguration == 1) 
            ...
            <div class="step active" id="step2-cons">
    ...
    <div class="form-content">
        ...
        <div class="step-pane active" id="step2-cons">
            ...
            <form id="frm-consultorio-wizard">
                ...
                <div class="row">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <p class="text-info mb-4">Configura los rangos de horarios para tu consultorio. Puedes ajustar las horas de inicio y fin para cada período del día.</p>
                        </div>
                    </div>
                        ...
                        <div class="horario-section horario-manana">
                            ...
                            <div class="range-slider-container">
                                <div class="range-slider">
                                    <input type="range" 
                            wire:model.live="horario_manana_inicio" 
                            min="6" 
                            max="12" 
                            step="1" 
                            value="6"
                            class="range-input-min">
                                    <input type="range" 
                            wire:model.live="horario_manana_fin" 
                            min="7" 
                            max="12" 
                            step="1" 
                            value="12"
                            class="range-input-max">
                                    <div class="range-track" 
                                        style="left: {{ (($horario_manana_inicio - 6) / 6) * 100 }}%; width: {{ (($horario_manana_fin - $horario_manana_inicio) / 6) * 100 }}%;"></div>
                                </div>
                        ...
                        <div class="col-12 col-md-6 mt-3">
                            ...
                            <div class="horario-section horario-tarde">
                                ...
                                <div class="range-slider-container">
                                    <div class="range-slider">
                                         <input type="range" 
                                 wire:model.live="horario_tarde_inicio" 
                                 min="12" 
                                 max="18" 
                                 step="1" 
                                 value="12"
                                 class="range-input-min">
                                         <input type="range" 
                                 wire:model.live="horario_tarde_fin" 
                                 min="13" 
                                 max="18" 
                                 step="1" 
                                 value="18"
                                 class="range-input-max">
                                         <div class="range-track" 
                                              style="left: {{ (($horario_tarde_inicio - 12) / 6) * 100 }}%; width: {{ (($horario_tarde_fin - $horario_tarde_inicio) / 6) * 100 }}%;"></div>
                                     </div>
                        ...
                        <div class="col-12 col-md-6 mt-3">
                            ...
                            <div class="horario-section horario-noche">
                                ...
                                <div class="range-slider-container">
                                    <div class="range-slider">
                                         <input type="range" 
                                 wire:model.live="horario_noche_inicio" 
                                 min="18" 
                                 max="22" 
                                 step="1" 
                                 value="18"
                                 class="range-input-min">
                                         <input type="range" 
                                 wire:model.live="horario_noche_fin" 
                                 min="19" 
                                 max="22" 
                                 step="1" 
                                 value="22"
                                 class="range-input-max">
                                         <div class="range-track" 
                                              style="left: {{ (($horario_noche_inicio - 18) / 4) * 100 }}%; width: {{ (($horario_noche_fin - $horario_noche_inicio) / 4) * 100 }}%;"></div>
                                     </div>
